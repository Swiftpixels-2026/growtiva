...
export const STORIES: Story[] = [
  {
    ...
    cover: nigeria,
    coverCredit: "Photograph by Tope Adenola for Growtiva Africa",
    issueSlug: "issue-01",
    tags: ["Operators", "Lagos", "Distribution", "Founders"],
    pullQuote: {
      text: "The market doesn't reward storytelling here. It rewards consistency. If you ship every week for five years, you win.",
      attribution: "Tunde, B2B distribution, Surulere",
    },
    sidenote: {
      label: "On the ground",
      body: "Reporting for this piece took place across Yaba, Surulere, and Lekki between January and March 2026. Names of two operators have been changed at their request.",
    },
    relatedSlugs: ["the-new-economics-of-staying", "what-we-wear-when-we-arrive"],
    paragraphs: [
  ...
  },
  {
    ...
    authorSlug: "lerato-mokoena",
    readTime: "7 min read",
    publishedAt: "April 2026",
    cover: kenya,
    coverCredit: "Photograph by Wanjiru Kamau for Growtiva Africa",
    issueSlug: "issue-01",
    tags: ["Style", "Tailoring", "Heritage", "Class"],
    pullQuote: {
      text: "I dress for the people in the room with me. Not for anyone watching.",
      attribution: "A founder, Nairobi",
    },
    sidenote: {
      label: "On the makers",
      body: "Anyẹmi (Accra), an unnamed Lagos studio, and a Cape Town menswear archive label declined to be photographed for this piece. We honored their request.",
    },
    relatedSlugs: ["the-quiet-architects-of-lagos", "the-language-of-the-new-african-canon"],
    paragraphs: [
  ...
  },
  {
    ...
    authorSlug: "kwame-boateng",
    readTime: "11 min read",
    publishedAt: "April 2026",
    cover: morocco,
    coverCredit: "Photograph by Yassine El Idrissi for Growtiva Africa",
    issueSlug: "issue-01",
    tags: ["Music", "Language", "Internet", "Canon"],
    pullQuote: {
      text: "Cultural authority is no longer granted. It is negotiated, in public, in the comments under a verse.",
    },
    sidenote: {
      label: "Methodology",
      body: "Interviews for this essay were conducted across Accra, Lagos, and Johannesburg between November 2025 and February 2026. Several subjects requested to be quoted only by first name.",
    },
    relatedSlugs: ["what-we-wear-when-we-arrive", "the-quiet-architects-of-lagos"],
    paragraphs: [
  ...
  },
  {
    ...
    authorSlug: "ifeoma-nwachukwu",
    readTime: "10 min read",
    publishedAt: "April 2026",
    cover: southafrica,
    coverCredit: "Photograph by Sipho Dlamini for Growtiva Africa",
    issueSlug: "issue-01",
    tags: ["Personal Finance", "Diaspora", "Compensation", "Cities"],
    pullQuote: {
      text: "The answer is no longer automatic, and that change—from default to choice—is reshaping an entire cohort.",
    },
    sidenote: {
      label: "The model",
      body: "We compared compensation, tax, housing, and lifestyle costs across Lagos, Nairobi, Berlin, and Toronto for software, finance, design, and medicine roles at three career stages.",
    },
    relatedSlugs: ["the-quiet-architects-of-lagos", "the-language-of-the-new-african-canon"],
    paragraphs: [
...
export const BUSINESSES: Business[] = [
  ...
  { name: "Freetown Surf Co.", category: "Hospitality", city: "Freetown", country: "Sierra Leone",
    ...
    tags: ["Lodge", "Beachfront", "Sea View", "Retreat"] },
  { name: "Douala Eats", category: "Restaurant", city: "Douala", country: "Cameroon",
    ...
    tags: ["Cameroonian", "Casual", "Catering"] },
  ...
  { name: "Zanzibar Beach Hotel", category: "Hospitality", city: "Stone Town", country: "Tanzania",
    ...
    tags: ["Hotel", "Sea View", "Spa", "Beachfront"] },
  { name: "Lekki Loft Stays", category: "Hospitality", city: "Lagos", country: "Nigeria",
    ...
    tags: ["Airbnb", "City Stay", "Wifi", "Family-Friendly"] },
  { name: "Riad Yasmine", category: "Hospitality", city: "Marrakech", country: "Morocco",
    ...
    tags: ["Hotel", "Rooftop", "Spa", "Heritage"] },
  { name: "Table View Airbnb", category: "Hospitality", city: "Cape Town", country: "South Africa",
    ...
    tags: ["Airbnb", "Mountain View", "Wifi", "Long Stay"] },
  { name: "Mara Plains Lodge", category: "Hospitality", city: "Maasai Mara", country: "Kenya",
    ...
    tags: ["Lodge", "Safari", "All-Inclusive", "Family-Friendly"] },
  ...
  { name: "Jollof House Lagos", category: "Restaurant", city: "Lagos", country: "Nigeria",
    ...
    tags: ["Nigerian", "Fine Dining", "Tasting Menu"] },
  { name: "Habesha Kitchen", category: "Restaurant", city: "Addis Ababa", country: "Ethiopia",
    ...
    tags: ["Ethiopian", "Traditional", "Family-Friendly"] },
  { name: "Tagine House", category: "Restaurant", city: "Marrakech", country: "Morocco",
    ...
    tags: ["Moroccan", "Heritage", "Cooking Classes"] },
  { name: "Smoke & Bone Braai", category: "Restaurant", city: "Johannesburg", country: "South Africa",
    ...
    tags: ["South African", "Grill", "Wine Bar"] },
  { name: "Skyline Nairobi", category: "Restaurant", city: "Nairobi", country: "Kenya",
    ...
    tags: ["East African", "Rooftop", "Cocktails"] },
  { name: "Le Thieb", category: "Restaurant", city: "Dakar", country: "Senegal",
    ...
    tags: ["Senegalese", "Seafood", "Beachfront"] },
  ...
  { name: "Koshary Cairo", category: "Restaurant", city: "Cairo", country: "Egypt",
    ...
    tags: ["Egyptian", "Casual", "Family-Friendly"] },

  // ============ Fashion (7 additions, 8 total with Anyẹmi) ============
  { name: "Lagos Atelier", category: "Fashion", city: "Lagos", country: "Nigeria",
    blurb: "Bold ankara couture for global stages.",
    services: "Made-to-measure couture, ready-to-wear drops, and bespoke commissions in hand-printed ankara.",
    email: "studio@lagosatelier.ng", image: bFashLagos,
    tags: ["Couture", "Womenswear", "Ankara"] },
  { name: "Nairobi Modern", category: "Fashion", city: "Nairobi", country: "Kenya",
    blurb: "Minimalist boutique pairing East African textiles with quiet tailoring.",
    services: "Womenswear, capsule collections, personal styling, and trunk shows.",
    email: "hello@nairobimodern.ke", image: bFashNairobi,
    tags: ["Womenswear", "Boutique", "Minimalist"] },
  { name: "Cape Bespoke", category: "Fashion", city: "Cape Town", country: "South Africa",
    blurb: "Old-world menswear tailoring with a modern edge.",
    services: "Bespoke suits, shirting, alterations, and made-to-order formalwear.",
    email: "tailor@capebespoke.co.za", image: bFashCapetown,
    tags: ["Menswear", "Tailoring", "Bespoke"] },
  { name: "Riad Kaftan Co.", category: "Fashion", city: "Marrakech", country: "Morocco",
    blurb: "Hand-embroidered kaftans rooted in Moroccan craft.",
    services: "Kaftans, abayas, embroidery commissions, and resort-wear collections.",
    email: "hello@riadkaftan.ma", image: bFashMarrakech,
    tags: ["Kaftan", "Embroidery", "Heritage"] },
  { name: "Dakar Threads", category: "Fashion", city: "Dakar", country: "Senegal",
    blurb: "Streetwear label channeling West African urban energy.",
    services: "Limited drops, graphic apparel, collaborations, and pop-up retail.",
    email: "drops@dakarthreads.sn", image: bFashDakar,
    tags: ["Streetwear", "Graphic", "Unisex"] },
  { name: "Jozi Bridal House", category: "Fashion", city: "Johannesburg", country: "South Africa",
    blurb: "Couture bridal atelier for African weddings.",
    services: "Bespoke bridal gowns, beadwork, fittings, and wedding party styling.",
    email: "atelier@jozibridal.co.za", image: bFashJburg,
    tags: ["Bridal", "Couture", "Beadwork"] },
  { name: "Kigali Leather Co.", category: "Fashion", city: "Kigali", country: "Rwanda",
    blurb: "Hand-stitched leather goods made in Rwanda.",
    services: "Bags, wallets, belts, and made-to-order pieces in vegetable-tanned leather.",
    email: "studio@kigalileather.rw", image: bFashKigali,
    tags: ["Leather", "Handmade", "Accessories"] },

  // ============ Coffee (7 additions, 8 total with Karoo & Co.) ============
  { name: "Yirgacheffe Estate", category: "Coffee", city: "Addis Ababa", country: "Ethiopia",
    blurb: "Single-origin Ethiopian coffee from highland farms.",
    services: "Green bean export, micro-lot sourcing, farm tours, and direct trade partnerships.",
    email: "export@yirgacheffe.et", image: bCoffAddis,
    tags: ["Single Origin", "Farm", "Export"] },
  { name: "Maua Coffee Bar", category: "Coffee", city: "Nairobi", country: "Kenya",
    blurb: "Modern third-wave café serving Kenyan single origins.",
    services: "Espresso, pour-over, retail beans, and barista training.",
    email: "hello@mauacoffee.ke", image: bCoffNairobi,
    tags: ["Café", "Third Wave", "Training"] },
  { name: "Lekki Roasters", category: "Coffee", city: "Lagos", country: "Nigeria",
    blurb: "Specialty roastery supplying cafés across West Africa.",
    services: "Wholesale roasting, café build-outs, equipment supply, and barista coaching.",
    email: "wholesale@lekkiroasters.ng", image: bCoffLagos,
    tags: ["Roastery", "Wholesale", "Equipment"] },
  { name: "Bourbon Co-op", category: "Coffee", city: "Kigali", country: "Rwanda",
    blurb: "Women-led Rwandan coffee cooperative.",
    services: "Washed processing, fair-trade export, sample roasting, and origin trips.",
    email: "coop@bourbon.rw", image: bCoffKigali,
    tags: ["Cooperative", "Fair Trade", "Washed"] },
  { name: "Accra Bean House", category: "Coffee", city: "Accra", country: "Ghana",
    blurb: "Cozy specialty café and beanery in central Accra.",
    services: "Coffee bar, retail beans, brunch service, and cupping events.",
    email: "hi@accrabeanhouse.gh", image: bCoffAccra,
    tags: ["Café", "Brunch", "Cupping"] },
  { name: "Medina Coffee", category: "Coffee", city: "Marrakech", country: "Morocco",
    blurb: "Traditional spiced Moroccan coffee in the medina.",
    services: "Sit-down café service, traditional brewing, spice blends, and gift packs.",
    email: "salam@medinacoffee.ma", image: bCoffMarrakech,
    tags: ["Traditional", "Spiced", "Heritage"] },
  { name: "Dar Cupping Lab", category: "Coffee", city: "Mombasa", country: "Kenya",
    blurb: "Q-grader lab and tasting room for East African coffee.",
    services: "Quality grading, cupping sessions, sourcing consultancy, and certifications.",
    email: "lab@darcupping.co", image: bCoffDar,
    tags: ["Lab", "Q-Grader", "Sourcing"] },

  // ============ Design (7 additions, 8 total with Soko Studio) ============
  { name: "Lagos Brand Co.", category: "Design", city: "Lagos", country: "Nigeria",
    blurb: "Brand identity studio for ambitious African companies.",
    services: "Visual identity, brand strategy, naming, and design systems.",
    email: "studio@lagosbrand.ng", image: bDesLagos,
    tags: ["Branding", "Identity", "Strategy"] },
  { name: "Cape Interiors", category: "Design", city: "Cape Town", country: "South Africa",
    blurb: "Residential and hospitality interior design studio.",
    services: "Concept design, FF&E, project management, and styling for homes and hotels.",
    email: "hello@capeinteriors.co.za", image: bDesCapetown,
    tags: ["Interiors", "Hospitality", "Residential"] },
  { name: "Accra Type Studio", category: "Design", city: "Accra", country: "Ghana",
    blurb: "Typography and graphic studio rooted in Ghanaian print.",
    services: "Custom type, posters, editorial design, and packaging.",
    email: "type@accrastudio.gh", image: bDesAccra,
    tags: ["Typography", "Editorial", "Print"] },
  { name: "Kigali Architects", category: "Design", city: "Kigali", country: "Rwanda",
    blurb: "Sustainable architecture practice for the new East Africa.",
    services: "Architecture, masterplanning, sustainable design, and interiors.",
    email: "studio@kigaliarchitects.rw", image: bDesKigali,
    tags: ["Architecture", "Sustainable", "Masterplanning"] },
  { name: "Atelier Terre", category: "Design", city: "Marrakech", country: "Morocco",
    blurb: "Ceramic studio reviving Moroccan pottery traditions.",
    services: "Handmade tableware, custom commissions, hospitality orders, and workshops.",
    email: "atelier@terre.ma", image: bDesMarrakech,
    tags: ["Ceramics", "Handmade", "Workshops"] },
  { name: "Jozi Furniture Studio", category: "Design", city: "Johannesburg", country: "South Africa",
    blurb: "Contemporary African furniture, made by hand.",
    services: "Custom furniture, retail collections, contract orders, and finishing.",
    email: "make@jozifurniture.co.za", image: bDesJburg,
    tags: ["Furniture", "Custom", "Contract"] },
  { name: "Dakar Digital", category: "Design", city: "Dakar", country: "Senegal",
    blurb: "Product and UX studio for francophone Africa.",
    services: "Product design, UX research, design systems, and prototyping.",
    email: "hello@dakardigital.sn", image: bDesDakar,
    tags: ["UX", "Product", "Research"] },

  // ============ Education (8 new) ============
  { name: "Lagos Code Bootcamp", category: "Education", city: "Lagos", country: "Nigeria",
    blurb: "Intensive software engineering bootcamp with employer pipeline.",
    services: "Full-stack engineering tracks, employer placement, scholarships, and remote cohorts.",
    email: "admissions@lagoscode.ng", image: bEduLagos,
    tags: ["Bootcamp", "Engineering", "Placement"] },
  { name: "Kifaru STEM Academy", category: "Education", city: "Nairobi", country: "Kenya",
    blurb: "K-12 STEM and robotics academy for Kenyan students.",
    services: "After-school clubs, robotics camps, teacher training, and competitions.",
    email: "hello@kifarustem.ke", image: bEduNairobi,
    tags: ["K-12", "Robotics", "STEM"] },
  { name: "Cape MBA School", category: "Education", city: "Cape Town", country: "South Africa",
    blurb: "Executive MBA programme for African business leaders.",
    services: "Full and executive MBA, short courses, custom corporate programmes.",
    email: "admissions@capemba.co.za", image: bEduCapetown,
    tags: ["MBA", "Executive", "Business"] },
  { name: "Accra Reading Academy", category: "Education", city: "Accra", country: "Ghana",
    blurb: "International primary school with a reading-first curriculum.",
    services: "Primary education, library programmes, parent workshops, and after-school care.",
    email: "office@accrareading.gh", image: bEduAccra,
    tags: ["Primary", "International", "Library"] },
  { name: "Cairo Heritage University", category: "Education", city: "Cairo", country: "Egypt",
    blurb: "Heritage university offering Arabic and African studies.",
    services: "Undergraduate and graduate programmes, language institute, and research grants.",
    email: "registrar@cairoheritage.eg", image: bEduCairo,
    tags: ["University", "Arabic", "Research"] },
  { name: "Kigali Teachers College", category: "Education", city: "Kigali", country: "Rwanda",
    blurb: "Teacher training and continuous professional development.",
    services: "Diploma programmes, in-service training, curriculum development, and rural placements.",
    email: "info@kigaliteachers.rw", image: bEduKigali,
    tags: ["Teacher Training", "Professional", "Rural"] },
  { name: "Sahel Edtech", category: "Education", city: "Dakar", country: "Senegal",
    blurb: "French-language online learning platform for the Sahel.",
    services: "Self-paced courses, live cohorts, certifications, and B2B learning.",
    email: "bonjour@saheledtech.sn", image: bEduDakar,
    tags: ["Online", "French", "Certifications"] },
  { name: "Jozi Art School", category: "Education", city: "Johannesburg", country: "South Africa",
    blurb: "Independent art and design school for working artists.",
    services: "Diploma programmes, evening classes, residencies, and gallery shows.",
    email: "studio@joziart.co.za", image: bEduJburg,
    tags: ["Art", "Design", "Residency"] },
];
