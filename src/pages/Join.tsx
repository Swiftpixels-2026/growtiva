            ...
            {submitted ? (
              <div className="border border-foreground/15 p-8 md:p-12 animate-fade-in">
                ...
                <p className="mt-5 text-foreground/75 max-w-md leading-relaxed">
                  ...
                  applications weekly. If your work aligns with the Circle,
                  you'll hear from us directly within seven days.
                </p>
                <div className="mt-10 flex flex-wrap gap-4">
                  <Link
                    to="/"
                    className="inline-flex items-center bg-foreground text-background px-6 py-3 text-[12px] tracking-[0.22em] uppercase hover:bg-accent hover:text-foreground transition-colors"
                  >
                    Return Home
                  </Link>
                  <Link
                    to="/directory"
                    className="inline-flex items-center border border-foreground px-6 py-3 text-[12px] tracking-[0.22em] uppercase hover:bg-foreground hover:text-background transition-colors"
                  >
                    Explore Directory
                  </Link>
                </div>
              ...
              <>
                ...
                <form
                  onSubmit={onSubmit}
                  className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-5 max-w-xl"
                >
